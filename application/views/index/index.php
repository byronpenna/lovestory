	...
	<div class = "container">
		<div class="wrapper">
			<form action=<?php echo site_url("welcome/login") ?> method="post" name="Login_Form" class="form-signin">       
			    <h3 class="form-signin-heading">LoveStory <br> <small>"Una nueva experiencia social"</small></h3>
				  ...
				  <a href=<?php echo site_url("welcome/register") ?> class="btn btn-lg btn-success btn-block" >Registrarse</a>  			
			</form>			
		</div>
	</div>
</body>
